    ...
    <div class="container-fluid super">
        <div class="row">
            ...
            <div class="col-4 center">
                <div class="top">
                    <h5>Dịch vụ đưa đón</h5>
                    <div class="transport">
                        <p><i class="fas fa-dolly-flatbed" style="color: #337AB7;"></i>Đón khách tận nơi</p>
                        <p>5%</p>
                    </div>
                </div>
                <div class="bottom">
